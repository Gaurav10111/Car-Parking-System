...
public class ParkingRef {
	...
	private void initialize() {
		...
		JLabel Imgref = new JLabel("");
		Image img = new ImageIcon(this.getClass().getResource("/parkref1.png")).getImage();
		Imgref.setIcon(new ImageIcon(img));
		Imgref.setBounds(0, 75, 745, 328);
		frmCarParkingRef.getContentPane().add(Imgref);
	}
}